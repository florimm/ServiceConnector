...
namespace FakeBW
{
    public class Browser : IHideObjectMembers
    {
        ...
        private HttpRequest CreateRequest(string method, string path, Action<BrowserContext> browserContext)
        {
            var context =
                new BrowserContext();
            ...
            return new HttpRequest(method, path, requestStream, contextValues.Protocol, contextValues.QueryString)
                {
                    Headers = contextValues.Headers,
